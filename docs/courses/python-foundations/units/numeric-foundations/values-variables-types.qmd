...
lesson_id: numeric-foundations.values-variables-types
lesson_order: 10
...
- numeric-foundations
order: 10
colab_notebook: notebooks/courses/python-foundations/units/numeric-foundations/values-variables-types.ipynb
---
::: {.lesson-meta}
- **Level:** Beginner
