...
lesson_id: abstraction-and-reusable-patterns.logging-and-configuration
lesson_order: 80
...
order: 80
colab_notebook: notebooks/courses/python-foundations/units/abstraction-and-reusable-patterns/logging-and-configuration.ipynb
---
::: {.lesson-meta}
- **Level:** Intermediate
