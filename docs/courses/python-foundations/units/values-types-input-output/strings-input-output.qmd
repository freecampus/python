...
lesson_id: values-types-input-output.strings-input-output
lesson_order: 20
...
order: 20
colab_notebook: notebooks/courses/python-foundations/units/values-types-input-output/strings-input-output.ipynb
---
::: {.lesson-meta}
- **Level:** Beginner
