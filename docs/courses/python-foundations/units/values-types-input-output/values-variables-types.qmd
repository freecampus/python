...
lesson_id: values-types-input-output.values-variables-types
lesson_order: 10
...
order: 10
colab_notebook: notebooks/courses/python-foundations/units/values-types-input-output/values-variables-types.ipynb
---
::: {.lesson-meta}
- **Level:** Beginner
