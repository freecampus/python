...
lesson_id: object-oriented-programming.oop-basics
lesson_order: 10
...
order: 10
colab_notebook: notebooks/courses/python-foundations/units/object-oriented-programming/oop-basics.ipynb
---
::: {.lesson-meta}
- **Level:** Intermediate
...
%%| eval: true
flowchart LR
  student_class["class Student<br/>blueprint"] --> ada["object<br/>ada"]
  student_class --> grace["object<br/>grace"]
