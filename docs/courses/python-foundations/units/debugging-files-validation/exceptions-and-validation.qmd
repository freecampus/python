...
lesson_id: debugging-files-validation.exceptions-and-validation
lesson_order: 60
...
order: 60
colab_notebook: notebooks/courses/python-foundations/units/debugging-files-validation/exceptions-and-validation.ipynb
---
::: {.lesson-meta}
