...
lesson_id: debugging-files-validation.paths-and-text-files
lesson_order: 40
...
order: 40
colab_notebook: notebooks/courses/python-foundations/units/debugging-files-validation/paths-and-text-files.ipynb
---
::: {.lesson-meta}
