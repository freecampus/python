...
lesson_id: debugging-files-validation.error-messages
lesson_order: 10
...
order: 10
colab_notebook: notebooks/courses/python-foundations/units/debugging-files-validation/error-messages.ipynb
---
::: {.lesson-meta}
- **Level:** Beginner
