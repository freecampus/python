...
lesson_id: debugging-files-validation.structured-files
lesson_order: 50
...
order: 50
colab_notebook: notebooks/courses/python-foundations/units/debugging-files-validation/structured-files.ipynb
---
::: {.lesson-meta}
