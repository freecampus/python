...
lesson_id: reliable-python-projects.command-line-programs
lesson_order: 30
...
order: 30
colab_notebook: notebooks/courses/python-foundations/units/reliable-python-projects/command-line-programs.ipynb
---
::: {.lesson-meta}
