...
lesson_id: reliable-python-projects.testing-with-pytest
lesson_order: 50
...
order: 50
colab_notebook: notebooks/courses/python-foundations/units/reliable-python-projects/testing-with-pytest.ipynb
---
::: {.lesson-meta}
