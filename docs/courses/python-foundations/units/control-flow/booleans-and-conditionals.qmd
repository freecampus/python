...
lesson_id: control-flow.booleans-and-conditionals
lesson_order: 10
...
- control-flow
order: 10
colab_notebook: notebooks/courses/python-foundations/units/control-flow/booleans-and-conditionals.ipynb
---
::: {.lesson-meta}
- **Level:** Beginner
