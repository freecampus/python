...
lesson_id: programming-essentials.strings-input-output
lesson_order: 50
...
order: 50
colab_notebook: notebooks/courses/python-foundations/units/programming-essentials/strings-input-output.ipynb
---
::: {.lesson-meta}
- **Level:** Beginner
