...
lesson_id: programming-essentials.values-variables-types
lesson_order: 40
...
order: 40
colab_notebook: notebooks/courses/python-foundations/units/programming-essentials/values-variables-types.ipynb
---
::: {.lesson-meta}
- **Level:** Beginner
