...
aliases:
  - "/lessons/advanced-python-patterns/logging-and-configuration.html"
  - "/courses/advanced-python/advanced-python-patterns/logging-and-configuration.html"
lesson_id: "advanced-python-patterns.logging-and-configuration"
lesson_order: 50
...
order: 500
colab_notebook: "notebooks/lessons/advanced-python-patterns/logging-and-configuration.ipynb"
---
::: {.lesson-meta}
- **Level:** Intermediate
...
Logging is a ship captain's log: record important events so future you can understand
the journey.
:::
...
print is fine for quick learning, but logging is better for long-running programs and
libraries.
:::
...
{
  "id": "advanced-python-patterns-logging",
  "title": "Logging checkpoint",
  "instructions": "Choose an answer, then check your work.",
  "questions": [
    {
      "id": "main-idea",
      "prompt": "Which statement best describes Logging?",
      "options": [
        "Logging writes structured messages about what a program is doing.",
      ...
      "answer_index": 0,
      "explanation": "The key idea is: Logging writes structured messages about what a program is doing."
    },
    {
      "id": "analogy",
      ...
      "answer_index": 0,
      "explanation": "The analogy in this lesson is: Logging is a ship captain's log: record important events so future you can understand the journey."
    },
    {
      "id": "debugging-habit",
...
<script type="application/json" class="fcpython-ojs-quiz-config">
{
  "id": "advanced-python-patterns-configuration",
  "title": "Configuration checkpoint",
  "instructions": "Choose an answer, then check your work.",
  "questions": [
    {
      "id": "main-idea",
      "prompt": "Which statement best describes Configuration?",
      "options": [
        "Configuration stores values such as paths, thresholds, and modes outside core logic.",
        "It is mainly about memorizing every Python command before writing code.",
        "It is a topic you can safely skip because later tools replace it.",
      ...
      "answer_index": 0,
      "explanation": "The key idea is: Configuration stores values such as paths, thresholds, and modes outside core logic."
    },
    {
      "id": "analogy",
      "prompt": "What is the purpose of the analogy in this lesson?",
      ...
      "answer_index": 0,
      "explanation": "The analogy in this lesson is: Configuration is a control panel: change settings without rewiring the machine."
    },
    {
      "id": "debugging-habit",
      "prompt": "What is the best first debugging habit for this topic?",
